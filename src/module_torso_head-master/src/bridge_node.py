...
###**data-topics to move torso ###
from std_msgs.msg import Float64 	#input
from geometry_msgs.msg import Point		#input-output
...
def main(args):
	basic_module_name = 'TORSO_HEAD_BM'
	rospy.init_node(basic_module_name+'_bridge', anonymous=False)
